...
import CoursesView from '../components/CourseComponents/CoursesView';
		...
		<Container>
		  <Header >
			<Left style={{paddingLeft:20}}>
			  <H2 style={{paddingTop:10}}>Courses</H2>
			</Left>
			...
			<FlatList
			  ...
			  renderItem={({ item }) => (
				<View style={{ flex: 1, flexDirection: 'column', margin: 10 }}>
				  <CoursesView imageUri={require('../assets/images/Placeholder_Course.png')} title='English Course' price='250 EGP' />
				</View>
			  )}
